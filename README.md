...
> Status: Pre-Beta (v0.1.0-prebeta). An academic report with a TikZ workflow/settings figure is included at `report/scaffold_ai_status_report.pdf`. Build on Windows with MiKTeX using `build_report.bat`.
