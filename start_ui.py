...
def check_data_files():
    ...
    from scaffold_core.config import get_faiss_index_path, get_metadata_json_path
...
def main():
    ...
    if not check_data_files():
        print("\n💡 Tip: If you haven't set up the vector database yet, refer to the setup guide.")
