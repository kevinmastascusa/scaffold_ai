...
A Flask web application for testing and getting feedback on the enhanced query system
"""
...
def feedback_page():
    ...
    try:
        ...
        for file in sorted(feedback_files, reverse=True)[:50]:  # Show latest 50
...
if __name__ == '__main__':
    ...
    print("🔧 API endpoints available at: /api/query, /api/feedback, /api/health")
